public class Board {
    ...
    public Board() {
        ...
        board[0][4] = new Railroad("Railroad A", 200, 20);
        ...
        board[4][0] = new Railroad("Railroad B", 200, 20);
        ...
        board[4][8] = new Railroad("Railroad C", 200, 20);
        ...
        board[8][4] = new Railroad("Railroad D", 200, 20);
